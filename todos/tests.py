...
class TestListCreateTodos(TodoAPITestCase):
    ...
    def test_should_create_todo(self):
        ...
        self.assertEqual(Todo.objects.all().count(), previous_todo_count
                         + 1)
...
class TestTodoDetailViewAPIView(TodoAPITestCase):
